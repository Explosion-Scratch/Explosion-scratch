...
<li><a href="https://github.com/Explosion-Scratch/claude-unofficial-api">ℹ️ <b>claude-unofficial-api</b></a>: <i>Unofficial API for Claude-2 via Claude Web (Also CLI)</i></li>	
